...
var choice = function( m ){ 
   ...
   return   {
    ...
    　type: 'html-keyboard-response',
      ...
      trial_duration: 3000*bai,
      /*function() {
        return listcross[Math.floor(Math.random() * listcross.length)]*300*bai
...
},
{
    ...
    　type: 'html-keyboard-response',
      ...
      trial_duration: 3000*bai,
      /*function() {
        return listcross[Math.floor(Math.random() * listcross.length)]*700*bai
      },*/
      response_ends_trial: false,
}
     ],
...
//ここまでは練習課題
timeline.push(instructions_finishExercise);
...
for(var i = 0; i<128; i++){
  if(qlist02[i] == 2){ 
    ...
    timeline.push(instructions_relax);
  }else{
    timeline.push(choice2)
}};
//終わりの挨拶
